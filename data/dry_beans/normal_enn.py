...
class FullModel(nn.Module):
    def __init__(self, input_dim, hidden_dim, num_classes):
        ...
        self.mlp = Conv1DMLP(input_dim,  num_classes)
                ...
                for bins in bin_list:
                    ...
                    for epoch in range(epochs):
                        ...
                        for inputs, labels in train_loader:
                            ...
                            edm_loss = enn.train_edm(train_loader, test_loader, model, device, num_classes, bins, dm)
                            print('total loss components: ce_loss: ',ce_loss, ' edm_loss: ', edm_loss)
...
output_file_path = f'results_enn.csv'
